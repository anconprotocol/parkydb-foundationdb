...
import { FoundationDBAdapter } from './foundationdb'
const payload = {
...
test.beforeEach(async (t) => {
  const db = new FoundationDBAdapter()
...
test('put', async (t) => {
  ...
  const id = CID.parse('baguqeerabve7ug2qddskk3mpomdt3xdnhvh53jvmca7qh43p36y5hfoassoq').toString()
  const block = {
    dag:{
